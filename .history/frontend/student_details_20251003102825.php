                ...
                <form action="" style=" width: 100%;" class="px-3">
                    <div class="d-flex flex-column gap-3" >
                        ...
                        <div class="d-flex flex-column">
                            <label for="" class="text-secondary" style="font-size: 14px">Track</label>
                        ...
                        <!-- <div class="d-flex flex-column">
                            <label for="" class="text-secondary" style="font-size: 14px">Track</label>
                            <div class="d-flex gap-4" id="track">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="Academic">
                                    <label class="form-check-label" style="font-size: 15px" for="exampleRadios1">
                                       Academic
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="TechPro">
                    ...
                    setTimeout(() => {    
                        ...
                        setTimeout(() => {
                            ...
                            response.strands.forEach((strand) => {
                                ...
                                wrapper.innerHTML = `
                                    <input class="form-check-input" type="radio" name="" id="radio${strand.id}" value="${strand.id}">
