        ...
        <div style="display: grid; grid-template-columns: 250px 1fr">
            ...
            <div class="py-3 pe-3 ps-5">
                ...
                <div id="content" class="bg-white p-4 shadow rounded-4 mt-4" style="display: none;">
                    ...
                    <div id="paidBtn" style="display: none; font-weight: bold; cursor: pointer; justify-content: center ; padding: 7px 12px; width: 150px; font-size: 13px; background-color: #259C07; color: #fff" class="mb-3">
    ...
    <script>
        ...
        function renderTable(students, meta) {
            ...
            students.forEach((student, index) => {
                ...
                <td style="color: ${student.is_paid == true ? '#259C07' : '#F54927'}">${student.is_paid == true ? 'Paid' : 'Not Paid'}</td>
