        ...
        <div style="display: grid; grid-template-columns: 250px 1fr">
            ...
            <div class="py-3 pe-3 ps-5">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="add_teacher.php" id="add_teacher" class="btn btn-primaryfw-semibold text-white" style="background-color: #3498db; border: none">Add User</a>
                </div>
    ...
    <script>
        ...
        function fetchTeachers(page = 1) {
            ...
            .then(data => {
                ...
                renderTable(teacusershers, meta);
