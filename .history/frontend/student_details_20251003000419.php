    ...
    <div id="content" style="display: none" class="justify-content-center py-5 position-relative">
        <div class="bg-white shadow py-2" style="border-radius: 10px; border: 1px solid #000080; z-index: 1; width: 90%">
            ...
            <div class="flex-column align-items-center p-3 gap-3 mt-5" id="filterSelection" style="display: flex; justify-content: center;">
                <button class="btn btn-primary fw-semibold d-flex justify-content-center" id="searchLRN" style="background-color: #000080 !important; border: none; min-width: 240px; max-with: 350px; font-size: 13px; padding: 12px 0 12px 0">
                    Search by LRN
                </button>
