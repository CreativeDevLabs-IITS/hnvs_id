...
<div class="" style="background-color: #f1f1f1; width: 100%; min-height: 100vh; font-family: Poppins, sans-serif;">
    ...
    <div id="content" style="display: none" class="justify-content-center py-5 position-relative">
        <div class="bg-white shadow py-2" style="border-radius: 10px; border: 1px solid #000080; z-index: 1; width: 90%">
            ...
            <div id="contentSpinner" style="height: 100vh; display: none" class="flex-column gap-1 justify-content-center align-items-center">
            ...
            <div class="d-flex flex-column align-items-center p-3 gap-3 mt-5" id="filterSelection">
            ...
            <div id="infoFormCon" style="display: none">
                <form action="" class="d-flex gap-5 px-4 my-5">
                    <div class="d-flex flex-column gap-3 px-3" style="width: 100%;">
                        ...
                        <div class="input-group">
                            <label for="mName" class="text-secondary">Middle Name</label>
                        ...
                        <div class="input-group" id="suffixContainer">
                            <label for="section" class="text-secondary">Section</label>
                            <input type="text" id="section" style="width: 100%;" disabled placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="barangay" class="text-secondary">Barangay</label>
                            <input type="text" name="barangay" id="barangay" style="width: 100%;" placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="town" class="text-secondary">Town</label>
                            <input type="text" name="town" id="town" style="width: 100%;" placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="address" class="text-secondary">Emergency Contact Person</label>
                            <input type="text" name="address" id="address" style="width: 100%;" placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="contact" class="text-secondary">Emergency Contact Number</label>
