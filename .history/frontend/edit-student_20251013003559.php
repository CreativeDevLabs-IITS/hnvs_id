        ...
        $(document).ready(function() {
            ...
            .then(data => {
                ...
                strands.forEach(strand => {
                    let exists = Array.from(strandSelect.options).some( option =>
                        option.getAttribute('data-cluster') === strand.cluster &&
                        option.getAttribute('data-specialization') === strand?.specialization;
                    );
                    ...
                    if(!exists) {
                        ...
                        strandOption.setAttribute('data-cluster', strand.cluster);
                        strandoption.setAttribute('data-specialization', strand.specialization);
