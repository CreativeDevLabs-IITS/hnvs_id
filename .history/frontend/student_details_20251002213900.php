                ...
                <form action="" class="d-flex gap-5 px-4 my-5" id="lrnFormCon" style="display: none">
                    <div class="d-flex flex-column gap-3" style="width: 300px;">
                        <div class="input-group" >
                            ...
                            <input type="text" name="lrn" id="lrn" disabled style="width: 100%;" placeholder="">
                        </div>
                    </div>
                </form>
...
<script>
    ...
    document.getElementById("searchLRN").addEventListener("click", function (e) {
        ...
        document.getElementById('lrnFormCon').style.display = 'flex';
    });
    ...
    document.getElementById("searchName").addEventListener("click", function (e) {
        ...
        document.getElementById('formContainer').style.display = 'flex';
        document.getElementById('nameFormCon').style.display = 'flex';
    })
