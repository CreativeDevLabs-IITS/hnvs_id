                        ...
                        <div class="fw-bold fs-1 mt-3 d-flex align-items-center gap-2">
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center gap-1">
                                    <div style="background-color: #3498DB; width: 20px; height: 20px"></div>
                                    <div id="totalId" style="font-size: 15px; font-weight: 500"></div>
                                </div>
                                <div class="d-flex align-items-center gap-1">
                                    <div style="background-color: #F54927; width: 20px; height: 20px"></div>
                                    <div id="noIdTotal" style="font-size: 15px; font-weight: 500"></div>
                                </div>
                            </div>
                        </div>
                    </div>
