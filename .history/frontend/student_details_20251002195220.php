        ...
        <div class="bg-white shadow p-4" style="border-radius: 10px; border: 1px solid #000080; z-index: 1; width: 60%">
            ...
            <div class="d-flex align-items-center gap-3 flex-row-reverse">
                ...
                <form action="" class="d-flex my-5" style="">
                    <div class="d-flex gap-5" style="min-width: 300px, max-width: 600px">
                        <input type="hidden" id="studentID">
                        <div class="input-group" id="lrnForm">
                            <input type="text" name="lrn" id="lrn" style="width: 100%;" placeholder="Learner Reference No. (LRN)">
                        </div>
                        <div class="input-group" id="fnameForm" style="display: none">
                            <input type="text" name="fName" id="fName" style="width: 100%;" placeholder="First Name">
                        </div>
                        <div class="input-group" id="lnameForm" style="display: none">
                            <input type="text" name="lName" id="lName" style="width: 100%;" placeholder="Last Name">
                        </div>
                    </div>
                </form>
            </div>
