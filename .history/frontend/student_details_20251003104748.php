...
<div class="" style="background-color: #f1f1f1; width: 100%; min-height: 100vh; font-family: Poppins, sans-serif;">
    ...
    <div id="content" style="display: none" class="justify-content-center py-5 position-relative px-3">
        <div class="bg-white shadow py-2" style="border-radius: 10px; border: 1px solid #000080; z-index: 1; width: 800px;">
            ...
            <div id="infoFormCon" style="display: none; justify-content: center; width: 100%;" class="mt-4 flex-column">
                <form action="" style=" width: 100%;" class="px-3">
                ...
                <div class="gap-3 mt-4" style="width: 100%">
                    <button class="btn btn-primary fw-semibold d-flex justify-content-center" id="saveBtn" style="background-color: #000080 !important; border: none; width: 100%; font-size: 13px; padding: 12px 0 12px 0">
                        <div class="loader2 me-2" style="display: none;" id="saveSpinner"></div>
                        Save
                    </button>
                </div>
            </div>
