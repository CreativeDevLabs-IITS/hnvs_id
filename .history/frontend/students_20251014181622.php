...
<?php include 'partials/_head.php' ?>
            ...
            <div class="py-3 pe-3 ps-5">
                ...
                <div id="content" class="bg-white p-4 shadow rounded-4 mt-4" style="display: none;">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="dropdown d-flex flex-row-reverse no_print" id="noPrint">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a data-bs-toggle="modal" data-bs-target="#importModal" class="cursor-pointer dropdown-item text-dark d-flex gap-2 align-items-center" id="print" style="font-size: 13px" id="printTable" href="#">
                    ...
                    <div class="d-flex gap-2">
                        <div id="paidBtn" style="display: none; gap: 5px; font-weight: bold; cursor: pointer; justify-content: center ; padding: 7px 12px; width: 150px; font-size: 13px; background-color: #259C07; color: #fff" class="mb-3">
                            <div class="spinner-border spinner-border-sm" id="paidSpinner" style="display: none" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
                            Payment Done
                        </div>
                        <div id="removePaidBtn" style="display: none; gap: 5px; font-weight: bold; cursor: pointer; justify-content: center ; padding: 7px 12px; width: 150px; font-size: 13px; background-color: #F54927; color: #fff" class="mb-3">
    ...
    <script>
        ...
        function renderTable(students, meta) {
            ...
            if(document.getElementById('allCheckAll').checked) {
                checkedAll = true;
            }
            ...
            students.forEach((student, index) => {
                ...
                row.innerHTML = `
                <td><input class="form-check-input studentCheckbox" type="checkbox" ${is_checked ? 'checked' : ''} value="${student.id}" hidden></td>
                <td>
