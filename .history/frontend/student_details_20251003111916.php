            ...
            <div id="infoFormCon" style="display: none; justify-content: center; width: 100%;" class="mt-4 flex-column px-3">
                <form action="" style=" width: 100%;">
                    <div class="d-flex flex-column gap-3" >
                        ...
                        <div class="input-group">
                            <label for="person" class="text-secondary" style="font-size: 14px">Emergency Contact Person</label>
                            <input type="text" name="person" id="person" style="width: 100%; font-size: 15px" placeholder="">
                        </div>
                        <div class="input-group">
...
<script>
                ...
                if(!response.error) {
                    ...
                    setTimeout(() => {    
                        ...
                        setTimeout(() => {
                            ...
                            document.getElementById('person').value = response.data.emergency_contactt ?? '';
    ...
    $(document).on('click', '#saveInfoBtn', function(e) {
        ...
        let studentData = {
            ...
            strand: document.querySelector('input[name="studentStrand"]:checked').value,
