            ...
            <div class="d-flex align-items-center gap-3 flex-row-reverse">
                <div class="dropdown d-flex">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a data-bs-toggle="modal" data-bs-target="" class="dropdown-item text-dark d-flex gap-2 align-items-center" id="print" style="font-size: 13px" id="printTable" href="#">
                ...
                <form action="" class="d-flex my-5" style="">
                    <div class="d-flex gap-5" style="width: 300px">
