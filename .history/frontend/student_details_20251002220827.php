    ...
    <div id="content" style="display: none" class="justify-content-center py-5 position-relative">
        <div class="bg-white shadow py-2" style="border-radius: 10px; border: 1px solid #000080; z-index: 1; width: 90%">
            ...
            <div>
                ...
                <form action="" class="d-flex gap-5 px-4 my-5" id="lrnFormCon" style="display: none">
                    <div class="d-flex flex-column gap-3" style="width: 300px;">
                        <div class="input-group" >
                            <label for="lrn" class="text-secondary">Learner Reference No. (LRN)</label>
                            <input type="text" name="lrn" id="lrn" style="width: 100%;" placeholder="">
                        </div>
                    </div>
                </form>

                <form action="" class="d-flex gap-5 px-4 my-5" id="nameFormCon" style="display: none">
                    <div class="d-flex flex-column gap-3" style="width: 300px;">
                        <input type="hidden" id="teacherId">
                        <div class="input-group" >
                ...
                <div class="gap-3mt-4" style="width: 100%;">
                    <button class="btn btn-primary fw-semibold d-flex justify-content-center" id="submit" style="background-color: #000080 !important; border: none; width: 100%; font-size: 13px; padding: 12px 0 12px 0">
...
<script>
    ...
    function searchStudent() {
        return new Promise((resolve, reject) => {
            ...
            fetch(`${APP_URL}/api/search-student`, {
                method: 'POST',
                headers: {
