    ...
    <div id="searchForm" style="display: none" class="justify-content-center py-5 position-relative">
        <div class="bg-white shadow p-4" style="border-radius: 10px; border: 1px solid #000080; z-index: 1;">
            ...
            <form action="" class="d-flex gap-5 px-4 my-5">
                <div class="d-flex gap-5 justify-content-between" style="width: 80%;">
                    <input type="hidden" id="teacherId">
                    <div class="input-group" >
                        <label for="fName" class="text-secondary">LRN</label>
                        <input type="text" name="fName" id="fName" style="width: 100%;" placeholder="">
                    </div>
                    <div class="input-group">
                        <label for="mName" class="text-secondary">First Name</label>
