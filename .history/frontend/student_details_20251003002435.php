            ...
            <div id="formContainer" class="flex-column" style="display: none; justify-content: center">
                ...
                <form action="" class="gap-5 px-4 my-5" id="lrnFormCon" style="display: none; justify-content: center">
                    <div class="d-flex flex-column gap-3" style="width: 100%;">
                        <div class="input-group" >
                            <label for="lrnInput" class="text-secondary" style="font-size: 14">Learner Reference No. (LRN)</label>
                ...
                <form action="" class="gap-5 px-4 my-5" id="nameFormCon" style="display: none; justify-content: center">
                    <div class="d-flex flex-column gap-3" style="width: 100%;">
                        <input type="hidden" id="teacherId">
                        <div class="input-group" >
                            <label for="fnameInput" class="text-secondary" style="font-size: 14">First Name</label>
                            <input type="text" name="fnameInput" id="fnameInput" style="width: 100%;" placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="lnameInput" class="text-secondary" style="font-size: ">Last Name</label>
