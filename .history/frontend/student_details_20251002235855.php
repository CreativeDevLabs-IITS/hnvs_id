...
<div class="" style="background-color: #f1f1f1; width: 100%; min-height: 100vh; font-family: Poppins, sans-serif;">
    ...
    <div id="content" style="display: none" class="justify-content-center py-5 position-relative">
        <div class="bg-white shadow py-2" style="border-radius: 10px; border: 1px solid #000080; z-index: 1; width: 90%">
            ...
            <div class="flex-column align-items-center p-3 gap-3 mt-5" id="filterSelection" style="display: flex">
            ...
            <div id="formContainer" class="flex-column" style="display: none">
                <input type="hidden" id="teacherId">

                <form action="" class="gap-5 px-4 my-5" id="lrnFormCon" style="display: none">
                    <div class="d-flex flex-column gap-3" style="width: 300px;">
                        <div class="input-group" >
                            <label for="lrnInput" class="text-secondary">Learner Reference No. (LRN)</label>
                            <input type="text" name="lrnInput" id="lrnInput" style="width: 100%;" placeholder="">
                        </div>
                    </div>
                </form>

                <form action="" class="gap-5 px-4 my-5" id="nameFormCon" style="display: none">
                    <div class="d-flex flex-column gap-3" style="width: 300px;">
                        <input type="hidden" id="teacherId">
                        <div class="input-group" >
                            <label for="fnameInput" class="text-secondary">First Name</label>
                            <input type="text" name="fnameInput" id="fnameInput" style="width: 100%;" placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="lnameInput" class="text-secondary">Last Name</label>
                            <input type="text" name="lnameInput" id="lnameInput" style="width: 100%;" placeholder="">
                        </div>
                    </div>
                </form>
                <div class="gap-3 mt-4 p-3" style="">
            ...
            <div id="infoFormCon" style="display: none; justify-content: center">
                <form action="" class="d-flex gap-5 px-4 my-5">
                    <div class="d-flex flex-column gap-3 px-3" style="width: 100%;">
                        <input type="hidden" id="teacherId">
                        <div class="input-group" >
                            <label for="fName" class="text-secondary" style="font-size: 14px">First Name</label>
                            <input type="text" name="fName" id="fName" disabled style="width: 100% font-size: 15;" placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="mName" class="text-secondary" style="font-size: 14px">Middle Name</label>
                            <input type="text" name="mName" id="mName" disabled style="width: 100%; font-size: 15" placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="lName" class="text-secondary" style="font-size: 14px">Last Name</label>
                            <input type="text" name="lName" id="lName" disabled style="width: 100%; font-size: 15" placeholder="">
                        </div>
                        <div class="input-group" id="suffixContainer">
                            <label for="suffix" class="text-secondary" style="font-size: 14px">Suffix</label>
                            <input type="text" id="suffix" style="width: 100%; font-size: 15" disabled placeholder="">
                        </div>
                        <div class="input-group" id="suffixContainer">
                            <label for="section" class="text-secondary" style="font-size: 14px">Section</label>
                            <input type="text" id="section" style="width: 100%; font-size: 15" disabled placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="barangay" class="text-secondary" style="font-size: 14px">Barangay</label>
                            <input type="text" name="barangay" id="barangay" style="width: 100%; font-size: 15" placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="town" class="text-secondary" style="font-size: 14px">Town</label>
                            <input type="text" name="town" id="town" style="width: 100%; font-size: 15" placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="address" class="text-secondary" style="font-size: 14px">Emergency Contact Person</label>
                            <input type="text" name="address" id="address" style="width: 100%; font-size: 15" placeholder="">
                        </div>
                        <div class="input-group">
                            <label for="contact" class="text-secondary" style="font-size: 14px">Emergency Contact Number</label>
                            <input type="text" id="contact" style="width: 100%; font-size: 15" placeholder="">
                        </div>
