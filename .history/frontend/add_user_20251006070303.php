            ...
            <div class="py-3 pe-3 ps-5">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="mt-3 breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" style="font-size: 14px;"><a href="add_user.php" class="text-decoration-none text-dark">Create</a></li>
                    </ol>
                </nav>
                <div class="">
                    <div class="fs-4 mt-2">Add User</div>
                </div>
                ...
                <div id="content" style="display: none;">
                    ...
                    <div class="d-flex gap-3 align-items-center mt-4">
                        ...
                        <a href="users.php" class="btn btn-secondary fw-semibold text-white">Cancel</a>
                    </div>
                </div>
