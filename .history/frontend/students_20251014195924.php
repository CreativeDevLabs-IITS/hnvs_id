            ...
            <div class="py-3 pe-3 ps-5">
                ...
                <div id="content" class="bg-white p-4 shadow rounded-4 mt-4" style="display: none;">
                    ...
                    <div class="d-flex gap-2" class="mb-2">
                        ...
                        <div id="removePaidBtn" style="display: none; gap: 5px; font-weight: bold; cursor: pointer; justify-content: center ; padding: 7px 12px; width: 160px; font-size: 13px; background-color: #F54927; color: #fff">
