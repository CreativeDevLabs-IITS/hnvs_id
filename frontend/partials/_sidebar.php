...
<div class="bg-white" style="height: 90vh; position: sticky; top: 60px">
    <nav>
        <ul class="nav main_menu d-flex flex-column" style="margin-top: 35px">
            ...
            <li class="px-2" id="students_menu">
                <div class="mb-1">
        ...
        <ul class="nav main_menu mt-4 d-flex flex-column">
            ...
            <!-- <li class="px-2" id="strand_menu">
                <div class=" mb-1">
                    <a href="strands.php" class="<?= (strpos($currentPage, 'strands.php') !== false || strpos($currentPage, 'add-strand.php') !== false || $editStrand) ? 'active' : '' ?> py-2 nav_btns d-flex align-items-center" style="text-decoration: none; font-size: 15px; padding-left: 12px; padding-right: 12px">
                        <svg class="me-2" xmlns="http://www.w3.org/2000/svg"  width="17"  height="17"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-library"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 3m0 2.667a2.667 2.667 0 0 1 2.667 -2.667h8.666a2.667 2.667 0 0 1 2.667 2.667v8.666a2.667 2.667 0 0 1 -2.667 2.667h-8.666a2.667 2.667 0 0 1 -2.667 -2.667z" /><path d="M4.012 7.26a2.005 2.005 0 0 0 -1.012 1.737v10c0 1.1 .9 2 2 2h10c.75 0 1.158 -.385 1.5 -1" /><path d="M11 7h5" /><path d="M11 10h6" /><path d="M11 13h3" /></svg>                        
                        Strands
                    </a>
                </div>
            </li>
            <li class="px-2" id="sections_menu">
                <div class=" mb-1">
                    <a href="sections.php" class="<?= (strpos($currentPage, 'sections.php') !== false || strpos($currentPage, 'add-section.php') !== false) ? 'active' : '' ?> py-2 nav_btns d-flex align-items-center" style="text-decoration: none; font-size: 15px; padding-left: 12px; padding-right: 12px">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        .then(data => {
            ...
            if(data.role == 1) {
                document.getElementById('generate_menu').style.display = 'none',
