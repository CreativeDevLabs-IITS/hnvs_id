...
<div class="offcanvas offcanvas-end d-flex flex-column justify-content-center px-3" style="width: 1020px; background-color: #f1f1f1" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="top-con px-3 mt-3 pb-3">
        <div class="d-flex gap-4 mt-4" style="width: 100%; height: 100%">
            <div class="d-flex flex-column gap-4 align-items-center" style="width: 100%">
                <div class="d-flex justify-content-center fs-6 fw-semibold rounded shadow p-3 text-white" style="background-color: #3498db; width: 100%">STUDENT INFORMATION</div>                
...
<script>
    $(document).on('click', "#view_student", function() {
        ...
        document.getElementById('studentID').value = $(this).data('student-id');
