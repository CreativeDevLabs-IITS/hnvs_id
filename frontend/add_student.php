...
<?php include 'partials/_head.php' ?>
                    ...
                    <div class=" d-flex flex-column gap-4 bg-white p-4 shadow rounded-4 mt-4">
                        ...
                        <div class="d-flex gap-5">
                            <div class="input-group">
                                ...
                                <input type="file" id="signature" class="dropify" data-default-file="https://hnvs-id-be.creativedevlabs.com/images/default-signature.png">
                            </div>
                            <div class="input-group">
                                <label for="studentImg" class="text-dark">Student image</label>
                                <input type="file" id="studentImg" class="dropify" data-default-file="https://hnvs-id-be.creativedevlabs.com/images/default.jpg">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            fetch('https://hnvs-id-be.creativedevlabs.com/api/section/strand/list', {
                method: 'GET',
                headers: {
        ...
        $(document).on('click', '#addStudentBtn', function(e) {
            ...
            fetch(`https://hnvs-id-be.creativedevlabs.com/api/student/create/`, {
                method: 'POST',
                headers: {
